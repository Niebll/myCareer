                            ...
                            child: BackdropFilter(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  _buildMenuItem(
                                      "Upload Portfolio", Container()),
                                  _buildMenuItem("CareerPath", Container()),
                                  _buildMenuItem(
                                      "Penonton", ProfileStalkerPage()),
                                ],
                              ),
                            ),
                          ),
          ...
          return [
                          ...
                          children: [
                            ...
                            GestureDetector(
                                ...
                                child: SvgPicture.asset(
                                  "assets/icons/hamburger.svg", height: 24.h,
                                  width: 24.w,)),
                          ],
                        ),
                        SizedBox(height: 16.h),
            ...
            SliverToBoxAdapter(
              child: TabBar(
                ...
                tabs: [
                  Tab(
                    icon: _buildIcon("assets/icons/app_bar_porto.svg", 0),

                  ),
                  Tab(
                    icon: _buildIcon("assets/icons/app_bar_work_bag.svg", 1),
